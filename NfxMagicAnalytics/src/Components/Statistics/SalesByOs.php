...
class SalesByOs implements StatisticsInterface
{
    ...
    public function getStatisticsData(array $parameters, Context $context): array
    {
        ...
        $query = $qb
            ->select([
                'JSON_UNQUOTE(JSON_EXTRACT(JSON_EXTRACT(orders.custom_fields, "$.nfxStatistics"),"$.os")) as name',
            ...
            ->andWhere('JSON_EXTRACT(JSON_EXTRACT(orders.custom_fields, "$.nfxStatistics"),"$.os") IS NOT NULL')
            ->setParameters([
