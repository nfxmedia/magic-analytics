...
class Connector
{
    ...
    {
        if (Database::tableExist('nfx_lexicon_entry', $this->connection)) {
            try {
    ...
    {
        if (
            Database::tableExist('nfx_cross_selling_also_bought', $this->connection) &&
            Database::tableExist('nfx_cross_selling_also_viewed', $this->connection)
        ) {
            try {
