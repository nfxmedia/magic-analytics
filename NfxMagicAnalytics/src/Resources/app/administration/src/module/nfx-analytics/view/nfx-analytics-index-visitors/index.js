import template from './nfx-analytics-index-visitors.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-visitors', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.visitors.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            ...
            return [
                { name: this.$tc('nfx-analytics.view.visitors.totalVisitors'), data: seriesData },
                { name: this.$tc('nfx-analytics.view.visitors.desktopColumn'), data: seriesDataDesktop },
                { name: this.$tc('nfx-analytics.view.visitors.mobileColumn'), data: seriesDataMobile },
                { name: this.$tc('nfx-analytics.view.visitors.tabletColumn'), data: seriesDataTablet }
            ];
        },
        ...
        getGridColumns() {
            return [{
                property: 'date.date',
                dataIndex: 'date.date',
                label: this.$tc('nfx-analytics.view.visitors.dateColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'desktop',
                dataIndex: 'desktop',
                label: this.$tc('nfx-analytics.view.visitors.desktopColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'mobile',
                dataIndex: 'mobile',
                label: this.$tc('nfx-analytics.view.visitors.mobileColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'tablet',
                dataIndex: 'tablet',
                label: this.$tc('nfx-analytics.view.visitors.tabletColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.visitors.totalVisitors'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
