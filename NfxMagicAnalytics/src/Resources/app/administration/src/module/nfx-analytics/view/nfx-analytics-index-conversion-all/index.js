import template from './nfx-analytics-index-conversion-all.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-conversion-all', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.conversionAll.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                ...
                property: 'visitors',
                dataIndex: 'visitors',
                label: this.$tc('nfx-analytics.view.conversionAll.visitorsColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.conversionAll.conversionColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.conversionAll.conversionPercentColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
