import template from './nfx-analytics-index-variants-compare.html.twig';
import './nfx-analytics-index-variants-compare.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-variants-compare', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.variantsCompare.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.variantsCompare.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.variantsCompare.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '80px'
                ...
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('nfx-analytics.view.variantsCompare.salesColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '50px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.variantsCompare.productCountColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '50px'
