import template from './nfx-analytics-index-category-impressions.html.twig';
import './nfx-analytics-index-category-impressions.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-category-impressions', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.categoryImpressions.titleChart');
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.categoryImpressions.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum1',
                dataIndex: 'sum1',
                label: this.$tc('nfx-analytics.view.categoryImpressions.sum1Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum2',
                dataIndex: 'sum2',
                label: this.$tc('nfx-analytics.view.categoryImpressions.sum2Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.categoryImpressions.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
