import template from './nfx-analytics-index-products-inventory.html.twig';
import './nfx-analytics-index-products-inventory.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-products-inventory', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.productsInventory.numberColumn'),
                allowResize: true,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.productsInventory.nameColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '120px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.productsInventory.sumColumn'),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '40px'
                ...
                property: 'pprice',
                dataIndex: 'pprice',
                label: this.$tc('nfx-analytics.view.productsInventory.ppriceColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '65px'
                ...
                property: 'worth',
                dataIndex: 'worth',
                label: this.$tc('nfx-analytics.view.productsInventory.worthColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '65px'
