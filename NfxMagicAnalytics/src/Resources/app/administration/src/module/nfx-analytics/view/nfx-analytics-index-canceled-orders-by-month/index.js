import template from './nfx-analytics-index-canceled-orders-by-month.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-canceled-orders-by-month', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.canceledOrdersByMonth.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                property: 'date',
                dataIndex: 'date',
                label: this.$tc('nfx-analytics.view.canceledOrdersByMonth.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.canceledOrdersByMonth.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.canceledOrdersByMonth.sumColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
