import template from './nfx-analytics-index-orders-by-status.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-orders-by-status', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.ordersByStatus.titleChart');
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.ordersByStatus.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.ordersByStatus.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('nfx-analytics.view.ordersByStatus.salesColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
