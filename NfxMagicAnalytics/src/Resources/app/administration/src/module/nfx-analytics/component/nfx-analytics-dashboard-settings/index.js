import template from './nfx-analytics-dashboard-settings.html.twig';
import './nfx-analytics-dashboard-settings.scss';

const { Mixin, Component } = Shopware;
const { Criteria } = Shopware.Data;
const USER_CONFIG_KEY = 'nfx.analytics.dashboard';

Component.register('nfx-analytics-dashboard-settings', {
    template,
    ...
    methods: {
        ...
        onCloseSettings() {
            ...
            this.$nextTick(() => {
                this.$emit('nfx-statistics-settings-modal-closed', parseInt(this.statisticDateRanges.value, 10));
            })
        }
    }
});
