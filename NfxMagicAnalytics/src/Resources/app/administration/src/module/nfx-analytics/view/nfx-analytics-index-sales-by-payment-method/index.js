import template from './nfx-analytics-index-sales-by-payment-method.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-payment-method', {
    template,
    ...
    computed: {
        ...
        chartOptionsSalesByPayment() {
            return this.pieChartOptions('nfx-analytics.view.salesByPaymentMethod.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByPaymentMethod.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_payment_method' && this.activeStatistic.pathInfo) {
