import template from './nfx-analytics-index-customer-by-salutation.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-customer-by-salutation', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.customerBySalutation.titleChart');
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.customerBySalutation.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.customerBySalutation.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'percent',
                dataIndex: 'percent',
                label: this.$tc('nfx-analytics.view.customerBySalutation.percentColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
