import template from './nfx-analytics-index-sales-by-billing-country.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-billing-country', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByBillingCountry.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByBillingCountry.nameColumn'),
                //allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_billing_country' && this.activeStatistic.pathInfo) {
