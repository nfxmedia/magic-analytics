import template from './nfx-analytics-index-product-inactive-with-instock.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-product-inactive-with-instock', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.productInactiveWithInstock.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.productInactiveWithInstock.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.productInactiveWithInstock.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
