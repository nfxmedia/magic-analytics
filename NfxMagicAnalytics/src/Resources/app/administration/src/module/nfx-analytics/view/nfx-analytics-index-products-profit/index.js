import template from './nfx-analytics-index-products-profit.html.twig';
import './nfx-analytics-index-products-profit.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-products-profit', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.productsProfit.numberColumn'),
                allowResize: true,
                primary: true,
                inlineEdit: false,
                width: '90px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.productsProfit.nameColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '120px'
            }, {
                property: 'profit',
                dataIndex: 'profit',
                label: this.$tc('nfx-analytics.view.productsProfit.profitColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '50px'
                ...
                property: 'markUp',
                dataIndex: 'markUp',
                label: this.$tc('nfx-analytics.view.productsProfit.markUp'),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '30px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.productsProfit.sumColumn'),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '30px'
                ...
                property: 'pprice',
                dataIndex: 'pprice',
                label: this.$tc('nfx-analytics.view.productsProfit.ppriceColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '45px'
                ...
                property: 'cprice',
                dataIndex: 'cprice',
                label: this.$tc('nfx-analytics.view.productsProfit.cpriceColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: true,
                align: 'right',
                inlineEdit: false,
                width: '45px'
