import template from './nfx-analytics-index-product-soon-outstock.html.twig';
import './nfx-analytics-index-product-soon-outstock.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-product-soon-outstock', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.productSoonOutstock.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.productSoonOutstock.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.productSoonOutstock.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'stock',
                dataIndex: 'stock',
                label: this.$tc('nfx-analytics.view.productSoonOutstock.stockColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sold',
                dataIndex: 'sold',
                label: this.$tc('nfx-analytics.view.productSoonOutstock.soldColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
