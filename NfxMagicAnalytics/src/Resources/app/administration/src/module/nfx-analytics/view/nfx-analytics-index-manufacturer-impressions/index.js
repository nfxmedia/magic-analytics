import template from './nfx-analytics-index-manufacturer-impressions.html.twig';
import './nfx-analytics-index-manufacturer-impressions.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-manufacturer-impressions', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.manufacturerImpressions.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.manufacturerImpressions.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum1',
                dataIndex: 'sum1',
                label: this.$tc('nfx-analytics.view.manufacturerImpressions.sum1Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum2',
                dataIndex: 'sum2',
                label: this.$tc('nfx-analytics.view.manufacturerImpressions.sum2Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.manufacturerImpressions.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
