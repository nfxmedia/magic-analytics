import template from './nfx-analytics-index-customer-online.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-customer-online', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'time',
                dataIndex: 'time',
                label: this.$tc('nfx-analytics.view.customerOnline.timeColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'visitors',
                dataIndex: 'visitors',
                label: this.$tc('nfx-analytics.view.customerOnline.visitorsColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'logins',
                dataIndex: 'logins',
                label: this.$tc('nfx-analytics.view.customerOnline.loginsColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
