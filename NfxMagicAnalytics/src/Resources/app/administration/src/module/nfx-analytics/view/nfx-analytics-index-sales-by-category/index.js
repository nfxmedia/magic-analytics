import template from './nfx-analytics-index-sales-by-category.html.twig';
import './nfx-analytics-index-sales-by-category.scss';

const { Component, Context, Mixin } = Shopware;
const { EntityCollection } = Shopware.Data;

Component.register('nfx-analytics-index-sales-by-category', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByCategory.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.productNumberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.productNameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
