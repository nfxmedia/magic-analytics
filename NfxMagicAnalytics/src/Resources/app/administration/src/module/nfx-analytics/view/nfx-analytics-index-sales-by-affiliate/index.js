import template from './nfx-analytics-index-sales-by-affiliate.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-affiliate', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByAffiliate.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByAffiliate.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '200px'
    ...
    methods: {
        ...
        setLabels(data) {
            for (let i = 0; i < data.length; i++) {
                ...
                } else if (data[i].name === 'nfx-analytics.view.noAffiliate') {
                    data[i].name = this.$tc('nfx-analytics.view.noAffiliate');
                }
            }
            return data;
        },
