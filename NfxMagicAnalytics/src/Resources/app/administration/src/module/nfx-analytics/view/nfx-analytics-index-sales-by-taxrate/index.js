import template from './nfx-analytics-index-sales-by-taxrate.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-taxrate', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByTaxrate.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'taxRate',
                dataIndex: 'taxRate',
                label: this.$tc('nfx-analytics.view.salesByTaxrate.taxRateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'tax',
                dataIndex: 'tax',
                label: this.$tc('nfx-analytics.view.salesByTaxrate.taxColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.salesByTaxrate.sumColumn') + this.$tc('nfx-analytics.view.net'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
