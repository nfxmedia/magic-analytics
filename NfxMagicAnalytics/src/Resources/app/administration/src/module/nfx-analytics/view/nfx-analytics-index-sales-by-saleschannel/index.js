import template from './nfx-analytics-index-sales-by-saleschannel.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-saleschannel', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesBySaleschannel.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesBySaleschannel.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_saleschannel' && this.activeStatistic.pathInfo) {
