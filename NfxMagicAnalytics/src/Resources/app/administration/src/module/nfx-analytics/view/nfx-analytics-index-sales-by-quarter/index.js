import template from './nfx-analytics-index-sales-by-quarter.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-quarter', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesByQuarter.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_quarter' && this.activeStatistic.pathInfo) {
