import template from './nfx-analytics-index-unfinished-orders-by-payment.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-unfinished-orders-by-payment', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.unfinishedOrdersByPayment.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByPayment.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.countColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'gross',
                dataIndex: 'gross',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.salesColumn') + ' ' + this.$tc('nfx-analytics.view.gross'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'net',
                dataIndex: 'net',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.salesColumn') + ' ' + this.$tc('nfx-analytics.view.net'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'avgGross',
                dataIndex: 'avgGross',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.avgColumn') + ' ' + this.$tc('nfx-analytics.view.gross'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'position',
                dataIndex: 'position',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.positionColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'itemCount',
                dataIndex: 'itemCount',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.itemCountColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'avgCount',
                dataIndex: 'avgCount',
                label: this.$tc('nfx-analytics.view.unfinishedOrdersByCart.avgItemCountColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        ...
        setOthersLabel(data) {
            for (let i = 0; i < data.length; i++) {
                if (data[i].name === 'nfx-analytics.data.others') {
                    data[i].name = this.$tc('nfx-analytics.data.others');
                }
            }
