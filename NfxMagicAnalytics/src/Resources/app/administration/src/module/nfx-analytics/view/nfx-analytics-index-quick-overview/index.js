import template from './nfx-analytics-index-quick-overview.html.twig';
import './nfx-analytics-index-quick-overview.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-quick-overview', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('nfx-analytics.view.dateColumn'),
                allowResize: true,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.quickOverview.orderCountColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '100px'
            }, {
                ...
                label: this.$tc('nfx-analytics.view.quickOverview.firstTimeCountColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('nfx-analytics.view.quickOverview.salesColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'avg',
                dataIndex: 'avg',
                label: this.$tc('nfx-analytics.view.quickOverview.avgSalesColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'netto',
                dataIndex: 'netto',
                label: this.$tc('nfx-analytics.view.quickOverview.nettoSalesColumn'),
                allowResize: true,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'new',
                dataIndex: 'new',
                label: this.$tc('nfx-analytics.view.quickOverview.newCustomersColumn'),
                allowResize: true,
                inlineEdit: false,
                align: 'right',
                width: '100px'
                ...
                property: 'paying',
                dataIndex: 'paying',
                label: this.$tc('nfx-analytics.view.quickOverview.newPayingCustomersColumn'),
                allowResize: true,
                inlineEdit: false,
                align: 'right',
                width: '100px'
                ...
                property: 'visitors',
                dataIndex: 'visitors',
                label: this.$tc('nfx-analytics.view.quickOverview.visitorsColumn'),
                allowResize: true,
                inlineEdit: false,
                align: 'right',
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.quickOverview.impressionsColumn'),
                allowResize: true,
                inlineEdit: false,
                align: 'right',
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            this.summeryColumnNames = {
                count: this.$tc('nfx-analytics.view.quickOverview.orderCountColumn'),
                firstTimeCount: this.$tc('nfx-analytics.view.quickOverview.firstTimeCountColumn'),
                sales: this.$tc('nfx-analytics.view.quickOverview.salesColumn'),
                avgSales: this.$tc('nfx-analytics.view.quickOverview.avgSalesColumn'),
                netto: this.$tc('nfx-analytics.view.quickOverview.nettoSalesColumn'),
                new: this.$tc('nfx-analytics.view.quickOverview.newCustomersColumn'),
                paying: this.$tc('nfx-analytics.view.quickOverview.newPayingCustomersColumn'),
                visitors: this.$tc('nfx-analytics.view.quickOverview.visitorsColumn'),
                impressions: this.$tc('nfx-analytics.view.quickOverview.impressionsColumn')
            };
