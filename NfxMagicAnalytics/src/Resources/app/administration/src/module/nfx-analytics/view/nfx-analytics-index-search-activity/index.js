import template from './nfx-analytics-index-search-activity.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-search-activity', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.searchActivity.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('nfx-analytics.view.searchActivity.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.searchActivity.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
