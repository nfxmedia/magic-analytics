import template from './nfx-analytics-index-sales-by-products.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-products', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByProducts.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                ...
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('nfx-analytics.view.salesByProducts.salesColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'priceAV',
                dataIndex: 'priceAV',
                label: this.$tc('nfx-analytics.view.salesByProducts.priceAV') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
