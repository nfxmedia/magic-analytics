import template from './nfx-analytics-index-sales-all-invoice.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-all-invoice', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesAllInvoice.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
