import template from './nfx-analytics-index-search-terms.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-search-terms', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('nfx-analytics.view.searchTerms.searchTermColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.searchTerms.countColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'results',
                dataIndex: 'results',
                label: this.$tc('nfx-analytics.view.searchTerms.resultsColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.searchTerms.salesChannelNameColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
