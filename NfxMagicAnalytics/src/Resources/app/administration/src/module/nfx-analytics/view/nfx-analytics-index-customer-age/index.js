import template from './nfx-analytics-index-customer-age.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-customer-age', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.customerAge.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            ...
            const seriesData = this.seriesData.map((data) => {
                return { x: data.age, y: data.count };
            });
            seriesData.reverse();
        ...
        getGridColumns() {
            return [{
                property: 'age',
                dataIndex: 'age',
                label: this.$tc('nfx-analytics.view.customerAge.ageColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'percent',
                dataIndex: 'percent',
                label: this.$tc('nfx-analytics.view.customerAge.percentColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.customerAge.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'customer_age' && this.activeStatistic.pathInfo) {
