import template from './nfx-analytics-index-sales-by-promotion.html.twig';
import './nfx-analytics-index-sales-by-promotion.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-promotion', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByPromotion.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByPromotion.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'code',
                dataIndex: 'code',
                label: this.$tc('nfx-analytics.view.salesByPromotion.codeColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'discount',
                dataIndex: 'discount',
                label: this.$tc('nfx-analytics.view.salesByPromotion.discountColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.salesByPromotion.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.salesByPromotion.sumColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'avg',
                dataIndex: 'avg',
                label: this.$tc('nfx-analytics.view.salesByPromotion.avgColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        ...
        onColumnSortPromotion(column) {
            ...
            if (this.gridDataPromotion.length > 0 && this.gridDataPromotion[this.gridDataPromotion.length -1].name === this.$tc('nfx-analytics.data.others')) {
