import template from './nfx-analytics-index-sales-by-shipping-method.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-shipping-method', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByShippingMethod.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByShippingMethod.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_shipping_method' && this.activeStatistic.pathInfo) {
