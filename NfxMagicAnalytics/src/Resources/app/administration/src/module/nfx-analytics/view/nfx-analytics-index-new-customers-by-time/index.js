import template from './nfx-analytics-index-new-customers-by-time.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-new-customers-by-time', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.newCustomersByTime.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            ...
            return [
                { name: this.$tc('nfx-analytics.view.newCustomersByTime.sumChart'), data: seriesData1 },
                { name: this.$tc('nfx-analytics.view.newCustomersByTime.payingChart'), data: seriesData2 }
            ];
        },
        ...
        getGridColumns() {
            return [{
                property: 'date',
                dataIndex: 'date',
                label: this.$tc('nfx-analytics.view.newCustomersByTime.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.newCustomersByTime.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'paying',
                dataIndex: 'paying',
                label: this.$tc('nfx-analytics.view.newCustomersByTime.payingColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
