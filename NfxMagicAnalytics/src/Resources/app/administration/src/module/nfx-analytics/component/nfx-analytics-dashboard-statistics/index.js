import template from './nfx-analytics-dashboard-statistics.html.twig';

const { Mixin, Component, Context } = Shopware;
const { Criteria } = Shopware.Data;
const USER_CONFIG_KEY = 'nfx.analytics.dashboard';

Component.register('nfx-analytics-dashboard-statistics', {
    template,
    ...
    computed: {
        ...
        groupRepository() {
            return this.repositoryFactory.create('nfx_analytics_groups_config');
        },

        statisticsRepository() {
            return this.repositoryFactory.create('nfx_analytics_config');
        }
    },
    ...
    methods: {
        ...
        async createdComponent() {
            ...
            if (this.nfxAnalyticsConfig['NfxModulAnalytics.config.grossOrNet']) {
                this.grossOrNet = this.nfxAnalyticsConfig['NfxModulAnalytics.config.grossOrNet'];
            }
            if (this.nfxAnalyticsConfig['NfxModulAnalytics.config.chartType']) {
                this.displayOptions.chartType = this.nfxAnalyticsConfig['NfxModulAnalytics.config.chartType'];
                this.chartType = this.nfxAnalyticsConfig['NfxModulAnalytics.config.chartType'];
            }
            if (this.nfxAnalyticsConfig['NfxModulAnalytics.config.dashboardSaleschannels']) {
                this.salesChannelIds = this.nfxAnalyticsConfig['NfxModulAnalytics.config.dashboardSaleschannels'];
