import template from './nfx-analytics-index-sales-by-quarter-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-quarter-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesByQuarterPwreturn.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
