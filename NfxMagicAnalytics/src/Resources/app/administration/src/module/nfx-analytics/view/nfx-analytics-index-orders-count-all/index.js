import template from './nfx-analytics-index-orders-count-all.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-orders-count-all', {
    template,
    ...
    computed: {
        ...
        chartOptionsOrderCount() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.orderCountAll.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        orderCountSeries() {
            ...
            return [
                { name: this.$tc('nfx-analytics.view.orderCountAll.firstTimeCountChart'), data: seriesData1 },
                { name: this.$tc('nfx-analytics.view.orderCountAll.countChart'), data: seriesData2 }
            ];
        },
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('nfx-analytics.view.orderCountAll.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.orderCountAll.firstTimeCountColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.orderCountAll.returningCountColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.orderCountAll.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
