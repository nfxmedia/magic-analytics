import template from './nfx-analytics-index-sales-by-month.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-month', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.orderSalesMonthly.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_month' && this.activeStatistic.pathInfo) {
