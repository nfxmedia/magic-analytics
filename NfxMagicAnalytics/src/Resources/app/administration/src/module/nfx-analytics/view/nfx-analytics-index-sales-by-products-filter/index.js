import template from './nfx-analytics-index-sales-by-products-filter.html.twig';
import './nfx-analytics-index-sales-by-products-filter.scss';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-products-filter', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByProductsFilter.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.salesByProductsFilter.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByProductsFilter.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.salesByProductsFilter.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('nfx-analytics.view.salesByProductsFilter.salesColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
