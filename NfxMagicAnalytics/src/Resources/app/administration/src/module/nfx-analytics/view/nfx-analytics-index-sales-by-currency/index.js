import template from './nfx-analytics-index-sales-by-currency.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-currency', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByCurrency.titleChart');
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByCurrency.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.salesByCurrency.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.salesByCurrency.sumColumn') + this.$tc('nfx-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
