import template from './nfx-analytics-index-sales-by-billing-country-invoice.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-billing-country-invoice', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.salesByBillingCountryInvoice.titleChart', this.systemCurrency.symbol);
        },
