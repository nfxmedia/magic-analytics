import template from './nfx-analytics-index-single-product.html.twig';
import './nfx-analytics-index-single-product.scss';

const { Component, Mixin } = Shopware;
const { Criteria } = Shopware.Data;

Component.register('nfx-analytics-index-single-product', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.singleProduct.titleChart') + ' - ' + this.productName
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartClickOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.singleProduct.titleClicksChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('nfx-analytics.view.singleProduct.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.singleProduct.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'clicks',
                dataIndex: 'clicks',
                label: this.$tc('nfx-analytics.view.singleProduct.clicksColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
