import template from './nfx-analytics-index-lexicon-impressions.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-lexicon-impressions', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.lexiconImpressions.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.lexiconImpressions.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('nfx-analytics.view.lexiconImpressions.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
