import template from './nfx-analytics-index-category-compare.html.twig';
import './nfx-analytics-index-category-compare.scss';

const { Component, Context, Mixin } = Shopware;
const { EntityCollection } = Shopware.Data;

Component.register('nfx-analytics-index-category-compare', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('nfx-analytics.view.categoryCompare.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: 'nfx-analytics.view.categoryNameColumn',
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: 'nfx-analytics.view.salesCountColumn',
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
