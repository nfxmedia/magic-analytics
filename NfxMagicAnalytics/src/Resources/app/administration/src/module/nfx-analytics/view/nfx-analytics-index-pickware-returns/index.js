import template from './nfx-analytics-index-pickware-returns.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-pickware-returns', {
    template,
    ...
    computed: {
        getGridColumns() {
            return [{
                ...
                property: 'part',
                dataIndex: 'part',
                label: this.$tc('nfx-analytics.view.pickwareReturns.partColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
