import template from './nfx-analytics-index-sales-by-month-invoice.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-month-invoice', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesByMonthInvoice.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_month_invoice' && this.activeStatistic.pathInfo) {
