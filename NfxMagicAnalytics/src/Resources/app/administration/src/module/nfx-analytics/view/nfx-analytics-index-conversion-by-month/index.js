import template from './nfx-analytics-index-conversion-by-month.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-conversion-by-month', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.conversionByMonth.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                ...
                property: 'visitors',
                dataIndex: 'visitors',
                label: this.$tc('nfx-analytics.view.conversionByMonth.visitorsColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.conversionByMonth.conversionColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.conversionByMonth.conversionPercentColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
