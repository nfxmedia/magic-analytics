import template from './nfx-analytics-index-sales-all-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-all-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesAllPwreturn.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            let chartData = this.defaultChartSeriesDataWithDates(this.seriesData, 'date', 'newGross',this.$tc('nfx-analytics.view.salesAllPwreturn.newGrossColumn'));
            if (Array.isArray(chartData)) {
                chartData.push(this.defaultChartSeriesDataWithDates(this.seriesData, 'date', 'return',this.$tc('nfx-analytics.view.salesAllPwreturn.returnColumn'))[0]);
            }
