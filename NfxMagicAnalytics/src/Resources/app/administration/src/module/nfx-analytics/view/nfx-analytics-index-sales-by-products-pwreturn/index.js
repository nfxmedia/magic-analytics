import template from './nfx-analytics-index-sales-by-products-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-sales-by-products-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('nfx-analytics.view.salesByProductsPwreturn.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        chartSeriesData() {
            return this.defaultChartSeriesData(this.seriesData, 'name', 'newSum', 'Verkäufe', false, true);
        },
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('nfx-analytics.view.salesByProducts.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('nfx-analytics.view.salesByProducts.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('nfx-analytics.view.salesByProducts.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'stock',
                dataIndex: 'stock',
                label: this.$tc('nfx-analytics.view.stock'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'returnSum',
                dataIndex: 'returnSum',
                label: this.$tc('nfx-analytics.view.salesByProductsPwreturn.returnSumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'newSum',
                dataIndex: 'newSum',
                label: this.$tc('nfx-analytics.view.salesByProductsPwreturn.newSumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.salesByProducts.orderCount'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('nfx-analytics.view.manufacturer'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_products_pwreturn' && this.activeStatistic.pathInfo) {
