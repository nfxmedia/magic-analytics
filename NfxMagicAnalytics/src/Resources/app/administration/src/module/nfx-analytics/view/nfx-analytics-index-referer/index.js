import template from './nfx-analytics-index-referer.html.twig';

const { Component, Mixin } = Shopware;

Component.register('nfx-analytics-index-referer', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'date.date',
                dataIndex: 'date.date',
                label: this.$tc('nfx-analytics.view.referer.dateColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'referer',
                dataIndex: 'referer',
                label: this.$tc('nfx-analytics.view.referer.refererColumn'),
                allowResize: false,
                align: 'right',
                primary: true,
                inlineEdit: false,
                ...
                label: this.$tc('nfx-analytics.view.referer.deviceTypeColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'counted',
                dataIndex: 'counted',
                label: this.$tc('nfx-analytics.view.referer.countedColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
