    ...
    public function update(Connection $connection): void
    {
        $configFields = array (
            array(
                'name' => 'single_product',
                'group_name' => 'products',
                'label' => 'nfx-analytics.view.singleProduct.titleTree',
                'route_name' => 'nfx.analytics.getSingleProduct',
                'path_info' => '/nfx/analytics/getSingleProduct',
                'position' => 50,
                'active' => 1,
                'parameter' => '{"dashboard": {"hasTable": 0, "hasChart": 0, "showTable": 0, "showChart": 0, "position": 50}, "componentName": "nfx-analytics-index-single-product"}'),
        );
        ...
        $connection->executeStatement("UPDATE `nfx_analytics_config` as c
            SET c.group_name = 'visitors', c.active = 1, c.position = 50, c.parameter = JSON_SET(`parameter`, '$.dashboard.hasTable', 1, '$.dashboard.position', 50, '$.dashboard.hasChart', 1, '$.componentName', 'nfx-analytics-index-lexicon-impressions'), c.group_id=(SELECT g.id FROM `nfx_analytics_groups_config` as g
