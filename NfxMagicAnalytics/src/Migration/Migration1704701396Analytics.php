    ...
    public function update(Connection $connection): void
    {
        $configFields = [
            [
                ...
                'label' => 'nfx-analytics.view.salesByAccountTypes.titleTree',
                'route_name' => 'nfx.analytics.getSalesByAccountTypes',
                'path_info' => '/nfx/analytics/getSalesByAccountTypes',
                'position' => 50,
                'active' => 1,
                'parameter' => '{"dashboard": {"hasTable": 1, "hasChart": 1, "showTable": 0, "showChart": 0, "position": 50}, "componentName": "nfx-analytics-index-sales-by-account-types"}'
            ]
        ];
        ...
        $connection->executeStatement("
            ...
            SET c.group_name='customers', c.group_id=(SELECT g.id FROM `nfx_analytics_groups_config` as g
