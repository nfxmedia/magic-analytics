...
class Migration1608027541Analytics extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        {
            if (!$this->columnExist('nfx_analytics_config', 'group_name', $connection)
                    || !$this->columnExist('nfx_analytics_config', 'group_id', $connection))
            {
        ...
        $connection->executeStatement("UPDATE `nfx_analytics_config` as c SET c.group_id=(SELECT g.id FROM `nfx_analytics_groups_config` as g WHERE g.name=c.group_name LIMIT 1);");
    }
