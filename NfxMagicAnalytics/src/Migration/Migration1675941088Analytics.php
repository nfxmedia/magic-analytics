    ...
    public function update(Connection $connection): void
    {
        $configFields = array (
            array(
                ...
                'group_name' => 'visitors',
                'label' => 'nfx-analytics.view.customerOnline.titleTree',
                'route_name' => 'nfx.analytics.getCustomerOnline',
                'path_info' => '/nfx/analytics/getCustomerOnline',
                'position' => 52,
                'active' => 1,
                'parameter' => '{"dashboard": {"hasTable": 1, "hasChart": 0, "showTable": 0, "showChart": 0, "position": 52}, "componentName": "nfx-analytics-index-customer-online"}'),
        );
