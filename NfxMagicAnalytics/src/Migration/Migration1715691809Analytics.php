...
use Nfx\MagicAnalytics\Bootstrap\Database;
...
class Migration1715691809Analytics extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        try {
            if (Database::tableExist('nfx_analytics_invoice_date', $connection)) {
                $connection->executeStatement("ALTER TABLE `nfx_analytics_invoice_date` DROP FOREIGN KEY `fk.nfx_analytics_invoice_date.order_id`;");
            }
        } catch (\Exception) {
        }
        ...
        $toChange = [
            [
                ...
                'sql' => "UPDATE `nfx_analytics_config`
        ...
        $configFields = [
            [
                ...
                'group_name' => 'sales',
                'label' => 'nfx-analytics.view.categoryCompare.titleTree',
                'route_name' => 'nfx.analytics.getCategoryCompare',
                'path_info' => '/nfx/analytics/getCategoryCompare',
                'position' => 19,
                'active' => 1,
                'parameter' => '{"dashboard": {"hasTable": 0, "hasChart": 0, "showTable": 0, "showChart": 0, "position": 50}, "componentName": "nfx-analytics-index-category-compare"}'
            ],
            [
                'name' => 'sales_by_quarter',
                'group_name' => 'orders',
                'label' => 'nfx-analytics.view.salesByQuarter.titleTree',
                'route_name' => 'nfx.analytics.getSalesByQuarter',
                'path_info' => '/nfx/analytics/getSalesByQuarter',
                'position' => 4,
                'active' => 1,
                'parameter' => '{"dashboard": {"hasTable": 1, "hasChart": 1, "showTable": 0, "showChart": 0, "position": 4}, "componentName": "nfx-analytics-index-sales-by-quarter"}'
            ]
        ];
