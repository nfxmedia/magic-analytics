import template from './cbax-analytics-index-sales-by-quarter.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-quarter', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesByQuarter.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
