import template from './cbax-analytics-index-manufacturer-impressions.html.twig';
import './cbax-analytics-index-manufacturer-impressions.scss';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-manufacturer-impressions', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.manufacturerImpressions.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.manufacturerImpressions.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum1',
                dataIndex: 'sum1',
                label: this.$tc('cbax-analytics.view.manufacturerImpressions.sum1Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum2',
                dataIndex: 'sum2',
                label: this.$tc('cbax-analytics.view.manufacturerImpressions.sum2Column'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.manufacturerImpressions.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'manufacturer_impressions' && this.activeStatistic.pathInfo) {
