import template from './cbax-analytics-index-sales-by-month-invoice.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-month-invoice', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesByMonthInvoice.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
