import template from './cbax-analytics-index-sales-by-campaign.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-campaign', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByCampaign.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByCampaign.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        ...
        setLabels(data) {
            for (let i = 0; i < data.length; i++) {
                ...
                } else if (data[i].name === 'cbax-analytics.view.noCampaign') {
                    data[i].name = this.$tc('cbax-analytics.view.noCampaign');
                }
            }
            return data;
        },
