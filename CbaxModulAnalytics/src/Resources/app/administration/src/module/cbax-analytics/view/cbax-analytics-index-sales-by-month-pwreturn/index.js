import template from './cbax-analytics-index-sales-by-month-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-month-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesMonthlyPwreturn.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                property: 'date',
                dataIndex: 'date',
                label: this.$tc('cbax-analytics.view.orderSalesMonthly.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
