import template from './cbax-analytics-index-sales-by-quarter-invoice.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-quarter-invoice', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesByQuarterInvoice.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            let chartData = this.defaultChartSeriesData(this.seriesData, 'date', 'sumNet',this.$tc('cbax-analytics.view.sumColumn'), true);
            if (Array.isArray(chartData)) {
                chartData.push(this.defaultChartSeriesData(this.seriesData, 'date', 'count',this.$tc('cbax-analytics.view.countColumnShort'), true)[0]);
            }
