import template from './cbax-analytics-index-sales-by-account-types.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-account-types', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByAccountTypes.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByAccountTypes.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
