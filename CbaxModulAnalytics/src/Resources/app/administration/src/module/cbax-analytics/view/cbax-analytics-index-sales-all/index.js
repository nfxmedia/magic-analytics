import template from './cbax-analytics-index-sales-all.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-all', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.orderSales.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
