import template from './cbax-analytics-index-sales-by-quarter-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-quarter-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesByQuarterPwreturn.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
                ...
                yaxis: [
                    {
                        title: {
                            text: this.$tc('cbax-analytics.view.salesAllPwreturn.newGrossColumn')
                        },
                        min:0,
                        forceNiceScale: true,
                        labels:{
                        ...
                        opposite: true,
                        title: {
                            text: this.$tc('cbax-analytics.view.salesAllPwreturn.returnColumn')
                        },
                        labels:{
        ...
        chartSeriesData() {
            let chartData = this.defaultChartSeriesData(this.seriesData, 'date', 'newGross',this.$tc('cbax-analytics.view.salesAllPwreturn.newGrossColumn'), true);
            if (Array.isArray(chartData)) {
                chartData.push(this.defaultChartSeriesData(this.seriesData, 'date', 'return',this.$tc('cbax-analytics.view.salesAllPwreturn.returnColumn'), true)[0]);
            }
        ...
        getGridColumns() {
            return [{
                property: 'date',
                dataIndex: 'date',
                label: this.$tc('cbax-analytics.view.salesByQuarterInvoice.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'refund',
                dataIndex: 'refund',
                label: this.$tc('cbax-analytics.view.salesAllPwreturn.refundColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'return',
                dataIndex: 'return',
                label: this.$tc('cbax-analytics.view.salesAllPwreturn.returnColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'newGross',
                dataIndex: 'newGross',
                label: this.$tc('cbax-analytics.view.salesAllPwreturn.newGrossColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                label: this.$tc('cbax-analytics.view.salesAllPwreturn.newQuantityColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_quarter_pwreturn' && this.activeStatistic.pathInfo) {
