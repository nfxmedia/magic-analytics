import template from './cbax-analytics-index-sales-by-country.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-country', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByCountry.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByCountry.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
