import template from './cbax-analytics-index-orders-by-delivery-status.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-orders-by-delivery-status', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.ordersByDeliveryStatus.titleChart');
        },

        chartSeriesData() {
            return this.defaultChartSeriesData(this.seriesData, 'name', 'sum', 'Bestellungen');
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.ordersByDeliveryStatus.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.ordersByDeliveryStatus.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sales',
                dataIndex: 'sales',
                label: this.$tc('cbax-analytics.view.ordersByDeliveryStatus.salesColumn') + this.$tc('cbax-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'orders_by_delivery_status' && this.activeStatistic.pathInfo) {
