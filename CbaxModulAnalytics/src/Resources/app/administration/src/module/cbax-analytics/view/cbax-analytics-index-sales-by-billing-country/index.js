import template from './cbax-analytics-index-sales-by-billing-country.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-billing-country', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByBillingCountry.titleChart', this.systemCurrency);
        },
