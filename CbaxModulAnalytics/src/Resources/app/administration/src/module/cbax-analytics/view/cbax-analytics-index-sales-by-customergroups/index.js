import template from './cbax-analytics-index-sales-by-customergroups.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-customergroups', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByCustomergroups.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByCustomergroups.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
