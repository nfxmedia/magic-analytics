import template from './cbax-analytics-index-sales-by-promotion-others.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-promotion-others', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByPromotionOthers.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByPromotionOthers.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'discount',
                dataIndex: 'discount',
                label: this.$tc('cbax-analytics.view.salesByPromotionOthers.discountColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('cbax-analytics.view.salesByPromotionOthers.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.salesByPromotionOthers.sumColumn') + this.$tc('cbax-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'avg',
                dataIndex: 'avg',
                label: this.$tc('cbax-analytics.view.salesByPromotionOthers.avgColumnExport') + this.$tc('cbax-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_by_promotion_others' && this.activeStatistic.pathInfo) {
