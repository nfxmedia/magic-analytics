import template from './cbax-analytics-index-sales-all-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-all-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesAllPwreturn.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        chartSeriesData() {
            let chartData = this.defaultChartSeriesDataWithDates(this.seriesData, 'date', 'newGross',this.$tc('cbax-analytics.view.salesAllPwreturn.newGrossColumn'));
            if (Array.isArray(chartData)) {
                chartData.push(this.defaultChartSeriesDataWithDates(this.seriesData, 'date', 'return',this.$tc('cbax-analytics.view.salesAllPwreturn.returnColumn'))[0]);
            }
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'sales_all_pwreturn' && this.activeStatistic.pathInfo) {
