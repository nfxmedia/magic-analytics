import template from './cbax-analytics-index-product-low-instock.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-product-low-instock', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('cbax-analytics.view.productLowInstock.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.productLowInstock.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.productLowInstock.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'product_low_instock' && this.activeStatistic.pathInfo) {
