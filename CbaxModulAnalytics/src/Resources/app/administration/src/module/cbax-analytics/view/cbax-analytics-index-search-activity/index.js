import template from './cbax-analytics-index-search-activity.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-search-activity', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.searchActivity.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                ...
                label: this.$tc('cbax-analytics.view.searchActivity.dateColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('cbax-analytics.view.searchActivity.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'search_activity' && this.activeStatistic.pathInfo) {
