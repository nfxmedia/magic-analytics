import template from './cbax-analytics-index-sales-by-shipping-method.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-shipping-method', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByShippingMethod.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByShippingMethod.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
