import template from './cbax-analytics-index-sales-by-customer.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-customer', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesByCustomer.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('cbax-analytics.view.salesByCustomer.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByCustomer.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '70px'
                ...
                property: 'email',
                dataIndex: 'email',
                label: this.$tc('cbax-analytics.view.salesByCustomer.emailColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '70px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('cbax-analytics.view.salesByCustomer.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
                ...
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.salesByCustomer.sumColumn') + this.$tc('cbax-analytics.view.' + this.grossOrNet),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '70px'
                ...
                property: 'lastLogin',
                dataIndex: 'lastLogin',
                label: this.$tc('cbax-analytics.view.salesByCustomer.lastLoginColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '70px'
