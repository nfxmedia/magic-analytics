import template from './cbax-analytics-index-sales-by-month.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-month', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.orderSalesMonthly.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
