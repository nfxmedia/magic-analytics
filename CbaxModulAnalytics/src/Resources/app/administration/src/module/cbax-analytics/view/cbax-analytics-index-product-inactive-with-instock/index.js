import template from './cbax-analytics-index-product-inactive-with-instock.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-product-inactive-with-instock', {
    template,
    ...
    computed: {
        ...
        getGridColumns() {
            return [{
                property: 'number',
                dataIndex: 'number',
                label: this.$tc('cbax-analytics.view.productInactiveWithInstock.numberColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.productInactiveWithInstock.nameColumn'),
                allowResize: false,
                inlineEdit: false,
                width: '100px'
            }, {
                property: 'sum',
                dataIndex: 'sum',
                label: this.$tc('cbax-analytics.view.productInactiveWithInstock.sumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
    ...
    methods: {
        createdComponent() {
            ...
            if (this.activeStatistic.name === 'product_inactive_with_instock' && this.activeStatistic.pathInfo) {
