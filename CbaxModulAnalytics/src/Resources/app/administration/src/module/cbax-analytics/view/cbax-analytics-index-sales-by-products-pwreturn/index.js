import template from './cbax-analytics-index-sales-by-products-pwreturn.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-products-pwreturn', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.salesByProductsPwreturn.titleChart')
                },
                xaxis: {
                },
                yaxis: {
        ...
        getGridColumns() {
            return [{
                ...
                property: 'newSum',
                dataIndex: 'newSum',
                label: this.$tc('cbax-analytics.view.salesByProductsPwreturn.newSumColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
