import template from './cbax-analytics-index-sales-by-payment-method.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-payment-method', {
    template,
    ...
    computed: {
        ...
        chartOptionsSalesByPayment() {
            return this.pieChartOptions('cbax-analytics.view.salesByPaymentMethod.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesByPaymentMethod.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
