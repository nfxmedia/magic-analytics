import template from './cbax-analytics-index-customer-age.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-customer-age', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return {
                title: {
                    text: this.$tc('cbax-analytics.view.customerAge.titleChart')
                },
                stroke: {
                    curve: 'smooth'
                },
        ...
        getGridColumns() {
            return [{
                property: 'age',
                dataIndex: 'age',
                label: this.$tc('cbax-analytics.view.customerAge.ageColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'percent',
                dataIndex: 'percent',
                label: this.$tc('cbax-analytics.view.customerAge.percentColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
                ...
                property: 'count',
                dataIndex: 'count',
                label: this.$tc('cbax-analytics.view.customerAge.countColumn'),
                allowResize: false,
                align: 'right',
                inlineEdit: false,
                width: '100px'
