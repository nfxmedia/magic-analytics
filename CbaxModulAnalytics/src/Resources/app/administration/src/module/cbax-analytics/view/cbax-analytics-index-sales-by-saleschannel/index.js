import template from './cbax-analytics-index-sales-by-saleschannel.html.twig';

const { Component, Mixin } = Shopware;

Component.register('cbax-analytics-index-sales-by-saleschannel', {
    template,
    ...
    computed: {
        ...
        chartOptions() {
            return this.pieChartOptions('cbax-analytics.view.salesBySaleschannel.titleChart', this.systemCurrency);
        },
        ...
        getGridColumns() {
            return [{
                property: 'name',
                dataIndex: 'name',
                label: this.$tc('cbax-analytics.view.salesBySaleschannel.nameColumn'),
                allowResize: false,
                primary: true,
                inlineEdit: false,
                width: '100px'
