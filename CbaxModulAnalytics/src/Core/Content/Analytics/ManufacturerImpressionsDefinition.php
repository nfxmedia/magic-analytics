...
class ManufacturerImpressionsDefinition extends EntityDefinition
{
    public const ENTITY_NAME = 'cbax_analytics_manufacturer_impressions';
    ...
    {
        return ManufacturerImpressionsCollection::class;
    }
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('manufacturer_id', 'manufacturerId', ProductManufacturerDefinition::class))->addFlags(new Required()),
