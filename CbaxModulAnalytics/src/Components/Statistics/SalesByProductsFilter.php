...
class SalesByProductsFilter implements StatisticsInterface
{
    ...
    public function getStatisticsData(array $parameters, Context $context): array
    {
        ...
        if (empty($result)) return ['success' => true, 'gridData' => [], 'seriesData' => [], 'overall' => 0, 'overallCount' => 0];
        ...
        if (empty($productIds)) return ['success' => true, 'gridData' => [], 'seriesData' => [], 'overall' => 0, 'overallCount' => 0];
