...
class SalesByBrowser implements StatisticsInterface
{
    ...
    public function getStatisticsData(array $parameters, Context $context): array
    {
        ...
        $query = $qb
            ->select([
                'JSON_UNQUOTE(JSON_EXTRACT(JSON_EXTRACT(orders.custom_fields, "$.cbaxStatistics"),"$.browser")) as name',
            ...
            ->andWhere('JSON_EXTRACT(JSON_EXTRACT(orders.custom_fields, "$.cbaxStatistics"),"$.browser") IS NOT NULL')
            ->setParameters([
